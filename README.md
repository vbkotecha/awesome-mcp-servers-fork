...
- <img src="https://agentservices.to/logo.png" height="14"/> [AgentServices](https://github.com/vbkotecha/aiservices-api)<sup><sup>⭐</sup></sup> - Paid x402 APIs for AI agents: crypto market data, financial data, news, and AI inference with 37 MCP tools. USDC nanopayments on Base.
