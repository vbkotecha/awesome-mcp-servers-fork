...
- <img src="https://cdn.simpleicons.org/bitcoin/F7931A" height="14"/> [AgentServices](https://api.aiservices.to/mcp) - Paid APIs for AI agents with built-in x402 payment protocol, crypto data, DeFi yields, and dispute resolution for agent commerce
...
- [AgentServices](https://agentservices.to) - Paid APIs for AI agents — 53 services, 41 paid, 37 MCP tools. x402 payments on Base. [GitHub](https://github.com/vbkotecha/aiservices-api) · [MCP endpoint](https://agentservices.to/mcp)
